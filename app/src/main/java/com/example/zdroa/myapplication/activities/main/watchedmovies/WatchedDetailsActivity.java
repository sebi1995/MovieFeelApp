...
public class WatchedDetailsActivity extends AppCompatActivity {
    ...
    private static ArrayList<String> production_countries;
    private static ArrayList<String> spoken_languages;
    private static ArrayList<String> youtube_links;
    private TextView movieWatched;
    private TextView noTrailersToShow;
    private ImageView trailer1;
    private ImageView trailer2;

    private Integer userId;

    private static UserSessionHandler userSession;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movieWatched = findViewById(R.id.watched_details_tv_favourite);
        movieWatched.setTextColor(Color.RED);

        noTrailersToShow = findViewById(R.id.watched_details_tv_no_trailers);

        trailer1 = findViewById(R.id.watched_details_iv_trailer_1);
        trailer2 = findViewById(R.id.watched_details_iv_trailer_2);
